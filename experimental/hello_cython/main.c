...
static char __pyx_doc_4main_fib[] = "Print the Fibonacci series up to n.";
static PyMethodDef __pyx_mdef_4main_1fib = {"fib", (PyCFunction)__pyx_pw_4main_1fib, METH_O, __pyx_doc_4main_fib};
 ...
 *         a, b = b, a + b
 */
    if (__Pyx_PrintOne(0, __pyx_v_b) < 0) __PYX_ERR(0, 6, __pyx_L1_error)
 ...
 */
  ...
  __pyx_codeobj__2 = (PyObject*)__Pyx_PyCode_New(1, 0, 3, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple_, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_main_pyx, __pyx_n_s_fib, 1, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__2)) __PYX_ERR(0, 1, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
 ...
 * 
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_4main_1fib, NULL, __pyx_n_s_main_2); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 1, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
